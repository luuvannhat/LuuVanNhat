...
<?php include_once '../classes/cate/category.php';  ?>
<?php include '../classes/brand.php';  ?>
<?php include '../classes/product.php';  ?>
<?php
    // gọi class category
    $pd = new product();
    //Nếu không truyền vào productId thì quay trở lại trang productlist
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <table class="form">
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="price_mua" value="<?php echo $result_product['price_mua'] ?>" type="text"
                                class="medium" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="quantity" value="<?php echo $result_product['sl'] ?>" type="text"
                                class="medium" />
                        </td>
                    </tr>
